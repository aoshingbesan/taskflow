...
dashboard_model = api.model('Dashboard', {
    'stats': fields.Raw(description='Task statistics'),
    'recent_tasks': fields.List(fields.Raw, description='Recent tasks')
})
...
class TaskList(Resource):
    ...
    @tasks_ns.doc(params={
        'status': 'Filter tasks by status (To Do, In Progress, Completed)'
    })
    @login_required
    def get(self):
